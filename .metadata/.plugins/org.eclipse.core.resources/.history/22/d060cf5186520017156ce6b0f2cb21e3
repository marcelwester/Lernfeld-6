...
public class Person {
	...
	Person(){
		...
		this.straﬂe=JOptionPane.showInputDialog("Straﬂe eingeben: ");
	...
	Person(String vorname, String nachname, String straﬂe, String hausnummer, String postleitzahl, String ort){
