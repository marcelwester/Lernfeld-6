...
public class NotenbilanzScrollListbox extends JFrame {
	...
	EventQueue.invokeLater(new Runnable() {
	    public void run() {
		try {
		    NotenbilanzScrollListbox frame = new NotenbilanzScrollListbox();
     ...
     * Create the frame.
     */
    public NotenbilanzScrollListbox() {
	...
	btnNotennummer = new JButton("markierte Note bearbeiten");
	btnNotennummer.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
		    try {
				notennummer = listNoten.getSelectedIndex();
	...
	btnNotennummer.setBounds(256, 84, 210, 21);
	...
	listNoten.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
