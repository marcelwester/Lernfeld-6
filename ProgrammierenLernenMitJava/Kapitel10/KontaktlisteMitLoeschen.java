...
/*
 * Programm Kontaktliste, ergänzt um die Möglichkeit, Einträge
 * zu löschen
 * 
 * Hans-Peter Habelitz
 * 2014-09-02
...
public class KontaktlisteMitLoeschen extends JFrame {
	...
	EventQueue.invokeLater(new Runnable() {
	    public void run() {
		try {
		    KontaktlisteMitLoeschen frame = new KontaktlisteMitLoeschen();
     ...
     * Create the frame.
     */
    public KontaktlisteMitLoeschen() {
