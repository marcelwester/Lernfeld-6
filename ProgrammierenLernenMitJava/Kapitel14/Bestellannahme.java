...
/*
 * Programm Bestellannahme (Musterlösung zur Kapitel 14 Aufgabe 3)
...
public class Bestellannahme extends JFrame implements TableModelListener {
	...
	EventQueue.invokeLater(new Runnable() {
	    public void run() {
		try {
		    Bestellannahme frame = new Bestellannahme();
