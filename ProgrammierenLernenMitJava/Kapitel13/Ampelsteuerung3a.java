...
/*
 * Programm Ampelsteuerung3a (mit eigenem Thread integriert in den ActionListener der CheckBox)
...
public class Ampelsteuerung3a extends javax.swing.JFrame {
	...
	EventQueue.invokeLater(new Runnable() {
	    public void run() {
		try {
		    Ampelsteuerung3a frame = new Ampelsteuerung3a();
