...
/*
 * Programm Ampelsteuerung4 (mit eigenem Thread)
 ...
 * Der Automatikmodus funktioniert und kann auch unmittelbar gestoppt
 * werden. 
 * 
 * Hans-Peter Habelitz
 * 2014-10-21
...
public class Ampelsteuerung4 extends javax.swing.JFrame implements Runnable {
	...
	EventQueue.invokeLater(new Runnable() {
	    public void run() {
		try {
		    Ampelsteuerung4 frame = new Ampelsteuerung4();
