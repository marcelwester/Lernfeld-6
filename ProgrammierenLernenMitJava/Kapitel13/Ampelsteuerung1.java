...
/*
 * Programm Ampelsteuerung1 (ohne eigenen Thread und ohne paintImmediately)
...
public class Ampelsteuerung1 extends JFrame {
	...
	EventQueue.invokeLater(new Runnable() {
	    public void run() {
		try {
		    Ampelsteuerung1 frame = new Ampelsteuerung1();
     ...
     * Create the frame.
     */
    public Ampelsteuerung1() {
	setTitle("Ampelsteuerung1");
