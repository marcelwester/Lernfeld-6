...
/*
 * Programm VerzeichnisinhaltMitFileChooser
 * Es wird der Inhalt eines Ordners getrennt nach Verzeichnissen und Dateien
 * in zwei Listen angezeigt. Das jeweils anzuzeigende Verzeichnis kann mit
 * Hilfe eines Dialogs ausgewählt werden.
 * 
 * Hans-Peter Habelitz
 * 2014-09-02
 */
...
public class VerzeichnisinhaltMitFileChooser extends JFrame {
	...
	EventQueue.invokeLater(new Runnable() {
	    public void run() {
		try {
		    VerzeichnisinhaltMitFileChooser frame = new VerzeichnisinhaltMitFileChooser();
     ...
     * Create the frame.
     */
    public VerzeichnisinhaltMitFileChooser() {
	...
	btnAuswaehlen.setBounds(305, 56, 119, 23);
