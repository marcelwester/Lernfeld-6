...
/*
 * Programm Zeichnen5 mit Farbauswahldialog
...
public class Zeichnen5 extends JFrame {
	...
	panelBedienelemente.setLayout(new MigLayout("",
		"[][grow][][grow][grow]", "[][][][][][][][][][][][]"));
	...
	btnFarbeWhlen.addActionListener(new ActionListener() {
		...
		farbe = JColorChooser.showDialog(null,
			"Wähle neue Zeichenfarbe", Color.black);
